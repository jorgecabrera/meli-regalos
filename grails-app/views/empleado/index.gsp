...
<body>
	...
	<div class="nav" role="navigation">
		<ul>
			<li><g:link class="calendar" action="verCalendario">
					<g:message code="Ver calendario" args="[entityName]" />
				</g:link></li>
			...
			<tbody>
				<g:each in="${empleadoInstanceList}" status="i"
					...
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:hiddenField name="lista_regalo"
								id="regalo${empleadoInstance.id}"
								value="${fieldValue(bean: empleadoInstance, field: "regalos")}" />
						</td> -->
					</tr>
